...
cp %{_builddir}/Dist-CheckConflicts-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Dist-CheckConflicts/deb7cee0a39b72f1581215f989bd3a0fc1d2638e || :
if test -f Makefile.PL; then
